...
const commands = [
  ...
  // NOTE (adapted at init / Gate G0): the npm-run battery — unit-tests,
  // db-integration-tests, browser-e2e-tests, eval-ratchet, lint, production-build
  // — is intentionally omitted until the stack is chosen (Phase 3) and those npm
  // scripts + evals are wired. Re-add each entry (see the reference header) as its
  // layer comes online so qa:verify grows with the project.
  {
    name: "openspec-all",
    command: "npx",
